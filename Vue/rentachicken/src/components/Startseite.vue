<template>
  <div>
    ...
    <div>
      <b-button class="button" @click="showModal">ABHOLEN</b-button>
      <b-modal
        class="modal"
        ref="my-modal"
        hide-header
      ...
      >
        <div class="modaltitles">
          <h3>Abholen</h3>
          <h4>Wie viele Eier hast du abholt?</h4>
        </div>
        <b-form-input class="eieingabe" type="number"> </b-form-input>
